...
"""
# From: https://jakevdp.github.io/blog/2013/01/13/hacking-super-mario-bros-with-python/
...
class NESGraphics(object):
    ...
    def __init__(self, filename='./roms/Super_mario_brothers.nes', offset=2049):
        self.offset = offset
...
if __name__ == '__main__':
    ...
    # Hat & Shirt (Red)	NES Red	#FF0000	Bright primary red
    # Overalls (Brownish)	Dark Brown	#7F3300	Looks brown because of NES palette limitations
    # Skin (Flesh tone)	Light Orange	#FFB380	Warm peach color
    # Shoes	Dark Brown	#7F3300	Same as overalls
    # Gloves	White	#FFFFFF	Standard white
    # Outline	Black	#000000	Standard black

    colors = {
        'hat_shirt': '#FF0000',
        'overalls_shoes': '#7F3300',
        'skin': '#FFB380',
        'gloves': '#FFFFFF',
        'outline': '#000000'
    }
    ...
    # Color	RGB	Hex
    # Brown	(66, 64, 1)	#424001
    # Red	(109, 32, 28)	#6D201C
    # Skin	(187, 127, 48)  #BB7F30

    # Regular mario.
    mario_colors = [colors['gloves'], colors['hat_shirt'], colors['skin'], colors['overalls_shoes']]
    ...
    # A = [[0, 1], [2, 3], [4, 5], [6, 7]]  # Tile indices
    A = [[50, 51], [52, 53]]  # Tile indices
    C = None  # No specific color table passed in (optional)

    # Initialize NES graphics object
    NG = NESGraphics()

    # Generate Mario image from pattern table
    im = NG.generate_image(A, C, transparent=False)
