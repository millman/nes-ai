...
LOSS_COLUMN_TO_HISTORY_ATTR: Dict[str, str] = {
    "step": "steps",
    "elapsed_seconds": "elapsed_seconds",
    "cumulative_flops": "cumulative_flops",
    "loss_world": "world",
    "loss_val_world": "val_world",
    "loss_val_recon": "val_recon",
    "loss_val_recon_multi_gauss": "val_recon_multi_gauss",
    "loss_val_recon_multi_box": "val_recon_multi_box",
    "loss_val_recon_zhat_multi_box": "val_recon_zhat_multi_box",
    "loss_val_recon_multi_box_mse": "val_recon_multi_box_mse",
    "loss_val_recon_patch": "val_recon_patch",
    "loss_jepa": "jepa",
    "loss_jepa_rep": "jepa_rep",
    "loss_jepa_open_loop": "jepa_open_loop",
    "loss_sigreg": "sigreg",
    "loss_z_smooth": "z_smooth",
    "loss_h_smooth": "h_smooth",
    "loss_recon": "recon",
    "loss_recon_multi_gauss": "recon_multi_gauss",
    "loss_recon_multi_box": "recon_multi_box",
    "loss_recon_zhat_multi_box": "recon_zhat_multi_box",
    "loss_recon_multi_box_mse": "recon_multi_box_mse",
    "loss_recon_patch": "recon_patch",
    "loss_pixel_delta": "pixel_delta",
    "loss_pixel_delta_multi_box": "pixel_delta_multi_box",
    "loss_h2z": "h2z",
    "loss_z2h": "z2h",
    "loss_z2h_init_zero": "z2h_init_zero",
    "loss_z2h_match_h": "z2h_match_h",
    "loss_h2z_delta": "h2z_delta",
    "loss_geometry_rank_p": "geometry_rank_p",
    "geometry_rank_p_accuracy": "geometry_rank_p_accuracy",
    "geometry_rank_p_pairs": "geometry_rank_p_pairs",
    "loss_inverse_dynamics_z": "inverse_dynamics_z",
    "loss_inverse_dynamics_h": "inverse_dynamics_h",
    "loss_inverse_dynamics_p": "inverse_dynamics_p",
    "loss_inverse_dynamics_dp": "inverse_dynamics_dp",
    "loss_action_delta_z": "action_delta_z",
    "loss_action_delta_h": "action_delta_h",
    "loss_rollout_kstep_z": "rollout_kstep_z",
    "loss_rollout_recon_z": "rollout_recon_z",
    "loss_rollout_recon_multi_box_z": "rollout_recon_multi_box_z",
    "loss_rollout_recon_delta_z": "rollout_recon_delta_z",
    "loss_rollout_recon_multi_box_delta_z": "rollout_recon_multi_box_delta_z",
    "loss_rollout_project_z": "rollout_project_z",
    "loss_rollout_recon_h": "rollout_recon_h",
    "loss_rollout_recon_multi_box_h": "rollout_recon_multi_box_h",
    "loss_rollout_kstep_h": "rollout_kstep_h",
    "loss_rollout_kstep_delta_h": "rollout_kstep_delta_h",
    ...
    "loss_loop_closure_p": "loop_closure_p",
    "loss_distance_corr_p": "distance_corr_p",
    "loss_noop_residual_dp": "noop_residual_dp",
    "loss_noop_residual_dh": "noop_residual_dh",
    "loss_same_frame_h_identity": "same_frame_h_identity",
    "loss_noop_move_orth_h": "noop_move_orth_h",
    "loss_additivity_dp": "additivity_dp",
    "loss_inverse_cycle_dp": "inverse_cycle_dp",
    "z_norm_mean": "z_norm_mean",
    "z_norm_std": "z_norm_std",
    "z_norm_max": "z_norm_max",
    "h_norm_mean": "h_norm_mean",
...
LOSS_COLUMNS = tuple(LOSS_COLUMN_TO_HISTORY_ATTR.keys())
...
def _loss_history_row(history: LossHistory, index: int) -> Dict[str, object]:
    return {
        column: getattr(history, history_attr)[index]
        for column, history_attr in LOSS_COLUMN_TO_HISTORY_ATTR.items()
    }
...
class LossCsvWriter:
    ...
    def open(self) -> None:
        ...
        self._writer = csv.DictWriter(self._handle, fieldnames=LOSS_COLUMNS, extrasaction="raise")
        if needs_header:
