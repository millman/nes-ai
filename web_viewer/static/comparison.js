...
const IMAGE_FOLDER_OPTIONS = [
  ...
  { value: "vis_self_distance_z", label: "Self-distance (Z):Distance", prefix: "self_distance_z_", folder: "vis_self_distance_z" },
  ...
  },
  {
    ...
    label: "Diagnostics (S):Action alignment",
    prefix: "action_alignment_detail_",
    folder: "vis_action_alignment_s",
  },
  { value: "vis_cycle_error", label: "Diagnostics (Z):Cycle error", prefix: "cycle_error_", folder: "vis_cycle_error_z" },
  { value: "vis_cycle_error_s", label: "Diagnostics (S):Cycle error", prefix: "cycle_error_", folder: "vis_cycle_error_s" },
  { value: "vis_adjacency", label: "Adjacency:Graph", prefix: "adjacency_", folder: "vis_adjacency" },
  { value: "vis_graph_rank1_cdf_z", label: "Graph Diagnostics (Z):Rank-1 CDF", prefix: "rank1_cdf_", folder: "graph_diagnostics_z" },
  { value: "vis_graph_rank2_cdf_z", label: "Graph Diagnostics (Z):Rank-2 CDF", prefix: "rank2_cdf_", folder: "graph_diagnostics_z" },
  { value: "vis_graph_neff_violin_z", label: "Graph Diagnostics (Z):Neighborhood size", prefix: "neff_violin_", folder: "graph_diagnostics_z" },
  { value: "vis_graph_in_degree_hist_z", label: "Graph Diagnostics (Z):In-degree", prefix: "in_degree_hist_", folder: "graph_diagnostics_z" },
  { value: "vis_graph_edge_consistency_z", label: "Graph Diagnostics (Z):Edge consistency", prefix: "edge_consistency_", folder: "graph_diagnostics_z" },
  { value: "vis_graph_metrics_history_z", label: "Graph Diagnostics (Z):Metrics history", prefix: "metrics_history_", folder: "graph_diagnostics_z" },
  { value: "vis_graph_rank1_cdf_s", label: "Graph Diagnostics (S):Rank-1 CDF", prefix: "rank1_cdf_", folder: "graph_diagnostics_s" },
  { value: "vis_graph_rank2_cdf_s", label: "Graph Diagnostics (S):Rank-2 CDF", prefix: "rank2_cdf_", folder: "graph_diagnostics_s" },
  { value: "vis_graph_neff_violin_s", label: "Graph Diagnostics (S):Neighborhood size", prefix: "neff_violin_", folder: "graph_diagnostics_s" },
