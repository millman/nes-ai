...
const IMAGE_FOLDER_OPTIONS = [
  ...
  { value: "pca_s", label: "Diagnostics:PCA (P)", prefix: "pca_s_", folder: "pca_s" },
  ...
  { value: "vis_self_distance_s", label: "Self-distance:Distance (P)", prefix: "self_distance_s_", folder: "vis_self_distance_s" },
  ...
  { value: "vis_delta_s_pca", label: "Diagnostics:Delta-p PCA", prefix: "delta_s_pca_", folder: "vis_delta_s_pca" },
  ...
  { value: "vis_odometry_current_s", label: "Odometry:Cumulative sum of Δp PCA/ICA/t-SNE", prefix: "odometry_s_", folder: "vis_odometry" },
  ...
  { value: "vis_odometry_s_vs_s_hat", label: "Odometry:||p - p_hat|| + scatter", prefix: "s_vs_s_hat_", folder: "vis_odometry" },
  ...
  { value: "vis_action_alignment_detail_s", label: "Diagnostics:Action alignment of PCA (P)", prefix: "action_alignment_detail_", folder: "vis_action_alignment_s" },
  { value: "vis_action_alignment_detail_raw_s", label: "Diagnostics:Action alignment of raw delta (P)", prefix: "action_alignment_detail_", folder: "vis_action_alignment_s_raw" },
  { value: "vis_action_alignment_detail_centered_s", label: "Diagnostics:Action alignment of centered delta (P)", prefix: "action_alignment_detail_", folder: "vis_action_alignment_s_centered" },
  ...
  { value: "vis_ctrl_smoothness_s", label: "Vis v Ctrl:Local smoothness (P)", prefix: "smoothness_s_", folder: "vis_vis_ctrl" },
  ...
  { value: "vis_ctrl_composition_s", label: "Vis v Ctrl:Two-step composition error (P)", prefix: "composition_error_s_", folder: "vis_vis_ctrl" },
  ...
  { value: "vis_composability_s", label: "Composability:Two-step (P)", prefix: "composability_s_", folder: "vis_composability_s" },
  ...
  { value: "vis_ctrl_stability_s", label: "Vis v Ctrl:Neighborhood stability (P)", prefix: "stability_s_", folder: "vis_vis_ctrl" },
  ...
  { value: "vis_cycle_error_s", label: "Diagnostics:Cycle error (P)", prefix: "cycle_error_", folder: "vis_cycle_error_s" },
  ...
  { value: "vis_straightline_s", label: "Diagnostics:Straight-line P", prefix: "straightline_s_", folder: "vis_straightline_s" },
  ...
  { value: "vis_graph_rank1_cdf_s", label: "Graph Diagnostics:Rank-1 CDF (P)", prefix: "rank1_cdf_", folder: "graph_diagnostics_s" },
  { value: "vis_graph_rank2_cdf_s", label: "Graph Diagnostics:Rank-2 CDF (P)", prefix: "rank2_cdf_", folder: "graph_diagnostics_s" },
  { value: "vis_graph_neff_violin_s", label: "Graph Diagnostics:Neighborhood size (P)", prefix: "neff_violin_", folder: "graph_diagnostics_s" },
  { value: "vis_graph_in_degree_hist_s", label: "Graph Diagnostics:In-degree (P)", prefix: "in_degree_hist_", folder: "graph_diagnostics_s" },
  { value: "vis_graph_edge_consistency_s", label: "Graph Diagnostics:Edge consistency (P)", prefix: "edge_consistency_", folder: "graph_diagnostics_s" },
  { value: "vis_graph_metrics_history_s", label: "Graph Diagnostics:Metrics history (P)", prefix: "metrics_history_", folder: "graph_diagnostics_s" },
].sort((a, b) => {
...
const IMAGE_FOLDER_DESCRIPTIONS = {
  ...
  pca_s: "PCA of world model pose (P). Read: clusters indicate distinct internal states; structure shows learned dynamics. Good: organized clusters reflecting game states.",
  ...
  vis_self_distance_s: "Self-distance matrix for P embeddings. Read: bright diagonals indicate temporal coherence; off-diagonal blocks show recurring states. Good: clear diagonal with periodic structure.",
  ...
  vis_delta_s_pca: "PCA of delta-P steps across the batch. Read: spokes or clusters correspond to action directions; separation shows distinct motions. Good: clear, separated clusters with minimal overlap.",
  ...
  vis_odometry_current_s: "Cumulative sum of Δp using PCA/ICA/t-SNE. Read: trajectory shows integrated motion; coherent paths indicate consistent action effects. Good: smooth, interpretable trajectories.",
  ...
  vis_odometry_s_vs_s_hat: "||p - p_hat|| comparison with scatter plot. Read: low error means accurate predictions; scatter shows error distribution. Good: tight clustering near origin.",
  ...
  vis_action_alignment_detail_s: "Per-action cosine alignment of delta-P directions. Read: values near 1 mean consistent action effects; near 0 means noisy alignment. Good: high alignment for common actions.",
  vis_action_alignment_detail_raw_s: "Per-action alignment of raw delta-P (unprocessed). Read: raw action effects before any normalization. Useful for debugging.",
  vis_action_alignment_detail_centered_s: "Per-action alignment of centered delta-P. Read: action effects after mean-centering. Good: clearer action-specific patterns.",
  ...
  vis_ctrl_smoothness_s: "Local smoothness of P representations. Read: measures how smoothly representations change. Good: low smoothness error indicates continuous representations.",
  ...
  vis_ctrl_composition_s: "Two-step composition error for P. Read: measures if two consecutive actions compose correctly. Good: low error means action effects are additive.",
  ...
  vis_composability_s: "Two-step composability for P. Read: compares model rollout vs additive deltas and action-pair strip errors. Good: low errors across timesteps and pairs.",
  ...
  vis_ctrl_stability_s: "Neighborhood stability for P. Read: measures if similar states stay similar after actions. Good: high stability means predictable dynamics.",
  ...
  vis_cycle_error_s: "Cycle error for P embeddings. Read: measures if opposite actions cancel out. Good: low error means reversible action effects.",
  ...
  vis_graph_rank1_cdf_s: "Rank-1 CDF for P graph. Read: distribution of top-1 neighbor accuracy. Good: high values at low thresholds.",
  vis_graph_rank2_cdf_s: "Rank-2 CDF for P graph. Read: distribution of top-2 neighbor accuracy. Good: high values at low thresholds.",
  vis_graph_neff_violin_s: "Neighborhood size (N_eff) for P. Read: violin plot of effective neighbor counts. Good: consistent, moderate neighborhood sizes.",
  vis_graph_in_degree_hist_s: "In-degree histogram for P graph. Read: distribution of incoming edges per node. Good: balanced distribution without outliers.",
