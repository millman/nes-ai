...
const IMAGE_FOLDER_DESCRIPTIONS = {
  ...
  vis_planning_h_grid_dist: "Planning H to grid distance. Read: histogram of nearest cosine distance from dataset h to grid-embedded h. Good: tight peak near 0.",
  vis_planning_lattice_test1_h: "Planning lattice (test1, H). Read: PCA projection of explored lattice nodes/edges from A*. Good: coherent local grid structure without chaos.",
  vis_planning_lattice_test2_h: "Planning lattice (test2, H). Read: PCA projection of explored lattice nodes/edges from A*. Good: coherent local grid structure without chaos.",
  vis_planning_lattice_test1_p: "Planning lattice (test1, P). Read: PCA projection of explored lattice nodes/edges from A*. Good: coherent local grid structure without chaos.",
  vis_planning_lattice_test2_p: "Planning lattice (test2, P). Read: PCA projection of explored lattice nodes/edges from A*. Good: coherent local grid structure without chaos.",
  vis_action_vector_field_h: "Position action vector field (H). Read: per-cell mean delta in H PCA space. Good: consistent direction for each action across cells.",
  vis_action_vector_field_p: "Position action vector field (P). Read: per-cell mean delta in P PCA space. Good: consistent direction for each action across cells.",
