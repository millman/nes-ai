...
const IMAGE_FOLDER_DESCRIPTIONS = {
  ...
  vis_composability_h: "Two-step composability for H. Read: compares model rollout vs additive deltas and action-pair strip errors. Good: low errors across timesteps and pairs.",
