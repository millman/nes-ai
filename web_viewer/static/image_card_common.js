...
const IMAGE_FOLDER_OPTIONS = [
  ...
  { value: "vis_rollout_divergence_z", label: "Diagnostics:Rollout divergence (Z)", prefix: "rollout_divergence_z_", folder: "vis_rollout_divergence_z" },
  { value: "vis_rollout_divergence_h", label: "Diagnostics:Rollout divergence (H)", prefix: "rollout_divergence_h_", folder: "vis_rollout_divergence_h" },
  { value: "vis_rollout_divergence_p", label: "Diagnostics:Rollout divergence (P)", prefix: "rollout_divergence_p_", folder: "vis_rollout_divergence_p" },
