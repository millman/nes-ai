...
const IMAGE_FOLDER_DESCRIPTIONS = {
  ...
  vis_planning_action_stats: "Planning action deltas summary (P). Read: per-action delta distributions and medians in pose space. Good: clean, separated action clusters.",
  vis_planning_action_stats_strip: "Planning action delta strip (P). Read: compact view of action delta directions and magnitudes. Good: consistent, separated bands.",
  ...
  vis_planning_exec_test1: "Planning execution trace (test1). Read: grid trace of executed plan in the environment. Good: path reaches the goal with few detours.",
  vis_planning_exec_test2: "Planning execution trace (test2). Read: grid trace of executed plan in the environment. Good: path reaches the goal with few detours.",
